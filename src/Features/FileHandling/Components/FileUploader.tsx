                ...
                <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 transform flex-col items-center gap-3">
                    <div className="flex flex-col gap-6 sm:flex-row">
                        ...
                        >
                            ...
                            >
                                Select Files
                                <Square2StackIcon className="ml-4 w-6 h-6" />
                            </div>
                            <Tooltip
                                id="select-files-button-tooltip"
                            />
                        </button>
                        <button
                            onClick={(e) => {
                        ...
                        >
                            ...
                            >
                                Select Folder
                                <FolderIcon className="ml-4 w-6 h-6" />
                            </div>
                            <Tooltip
                                id="select-folder-button-tooltip"
                            />
                        </button>
                    </div>
                </div>
