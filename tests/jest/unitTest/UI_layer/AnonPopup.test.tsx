...
const mockTags = [
    ...
    {
        tagId: "X00000001",
        tagName: "Cool Guy Levels",
        newValue: "Off the charts",
    },
...
describe("AnonPopup", () => {
    ...
    test("calls handleBlur on input blur, and input field gone", () => {
        ...
        expect(
            screen.queryByDisplayValue("0987654321")
